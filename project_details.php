...
<div class="container-fluid main-content">
    <div class="page-title" > <h4 ><a href="project_details.php?id=<?php echo $_GET['id'] ?>"><?php echo $projectDetails['project_title']; ?></a><?php if (isset($_GET['pap_id'])) { ?> < <a href="project_details.php?id=<?php echo $_GET['id']; ?>#tab-1"> Paps</a> < Pap detais <?php } ?></h4> </div>
                ...
                <div class="widget-container fluid-height clearfix">
                    <div class="tabs-container" id="project_page">
                        <ul class="nav nav-tabs">
                            ...
                            <li ><a data-toggle="tab" href="#tab-4"><i class="fa fa-group"></i> Report</a></li>
    ...
    <?php include("add_project_coverage_modal.php"); ?>
                            ...
                            <div id="tab-4" class="tab-pane ">
                                <div class="heading">
                                    <i class="fa fa-group"></i>Report
                                </div>
                                <div class="widget-content padded">
                                    <table class="table table-bordered table-striped" id="tblProjectReport">
                                        <thead>
                                            <tr>
                                                <th>PAP Ref</th>
                                                <th>Names</th>
    ...
    <?php endif; ?>
                                                ...
                                                <th>Dimensions</th>
                                                <th>Rate</th>
                                                <th>Improvements Value</th>
                                                <th>Type of Crop/Tree</th>
                                                <th>Description</th>
                                                <th>Quantity</th>
                                                <th>Rate</th>
                                                <th>Crop/Trees Value</th>
                                                <th>Sub Total</th>
                                            </tr>
                                        </thead>
                                        <tbody>
