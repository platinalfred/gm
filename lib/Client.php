...
class Client extends Db {
	...
	protected static $db_fields = array("id","client_names", "physical_address", "postal_address", "phone_contact1", "phone_contact2", "email_contact1", "email_contact2", "created_by","date_created","modified_by");
