...
class PropertyTypeDescription extends Db {
	...
	public function findPropertyTypeDescription(){
		...
		$fields = "`tbl_property_types_description`.`id`, tbl_property_type.`title` as propertytype, tbl_property_description.`title` as propertydescription";
		$result = $this->getfarray($table, $fields, "", "propertytype", "");
		return !empty($result) ? $result : false;
	}
