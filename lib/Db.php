...
class Db {
    ...
    public function __construct() {
        ...
        /*
         * mysql> use db_name;
         * mysql> source backup-file.sql; or SET autocommit=0; source backup-file.sql; COMMIT;
         */
    }
    ...
    function getLogin($email, $password) {
        ...
        $results = $this->getfrec("staff", "id, firstname, lastname, othername, email, position, password, password2", "email=BINARY '$email' AND status=1", "", "");
        if ($results) {
