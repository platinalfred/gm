...
(function() {
  ...
  $(document).ready(function() {
     ...
     * =============================================================================
     */
    if($("#myTab a:last").length){$("#myTab a:last").tab("show");}
     ...
     * =============================================================================
     */
    if($(".popover-trigger").length){$(".popover-trigger").popover();}
     ...
     * =============================================================================
     */
    if($(".tooltip-trigger").length){$(".tooltip-trigger").tooltip();}
