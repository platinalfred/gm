...
<div id="tabProjectReport" class="tab-pane active">
<div class="heading">
...
//Way Leave or both ROW and WL
                ...
                <td><?php if($i === 0){ echo $project_pap['way_leave']*1;  $wl_acreage += $project_pap['way_leave']; } ?></td>
                    <?php endif; ?>
                        <?php
//Total land size taken - Both ROW and WL Project
                        if($projectDetails['project_category_unit'] == 4):
                            ?>
...
//Dimunintion Rate - Both ROW and WL Project
                    if ($projectDetails['project_category_unit'] == 4):
                        ?>
...
//Right of Way or Both ROW and WL
                ...
                ?></td>
                    <?php //Total land value, applies to ROW, (Both ROW and WL) ?>
