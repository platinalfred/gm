            ...
            <div class="widget-container fluid-height clearfix">
                    ...
                    if (isset($_POST['from']) && is_numeric($_POST['from'])) {
                        ...
                        if (!empty($district_croptree_rates)) {
                            ...
                            if (isset($_POST['to']) && is_numeric($_POST['to']) && $_POST['from'] !== $_POST['to']) {
                                ...
                                print "<h3><em>Update done, $count records successfully updated.</em></h3>";
                                ...
                                print "<h3><em>Update done, $count records updated.</em></h3>";
                            } else {
                ...
                function print_html_form() {
                    ...
                    print "<div class=\"col-md-10 col-md-offset-1\">"
                            ...
                            . "<p>If you are planning on applying the rates to an existing project, then select the project the rates should be applied to.</p>";
